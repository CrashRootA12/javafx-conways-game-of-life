...
public class Board {
	...
	public Board (int height, int width, Scanner inputReader) {
		...
		System.out.println("The size of (2D Integer Sparse Array) object is "+fetchObjectSize()+" bytes");
	}
	...
	public void fetchPerformance_Time() {
		...
		System.out.println(("Time taken for processing 100 generations (Using 2D Sparse Integer Array): "
